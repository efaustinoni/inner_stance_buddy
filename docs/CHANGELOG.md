...
Architecture improvements (Phases 1–3): user-facing error handling, wouter router, performance optimisations, security hardening (CORS, CSP, SHA-256 salted security answers), and docs cleanup. See entries below for details.
